        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++) {
                ...
                if (ourAnimals[i, 2] == "Age: ?" && ourAnimals[i, 0] != "ID #: ") {
                    Console.Write($"The animal {ourAnimals[i, 0]} has no inserted age, please, insert an age for this animal ");

                     do {
                        Console.WriteLine($"\nEnter an age for the pet {ourAnimals[i, 0]}");
                        readResult = Console.ReadLine();
               ...
               if (ourAnimals[i, 4] == "Physical description: " && ourAnimals[i, 0] != "ID #: ") {
                Console.WriteLine($"\nThe animal {ourAnimals[i, 0]} has no description.");
                    do {
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++) {
                if (ourAnimals[i, 3] == "Nickname: " && ourAnimals[i, 0] != "ID #: ") {
                    Console.WriteLine($"The animal {ourAnimals[i, 0]} has no nickname\n");
                ...
                if (ourAnimals[i, 5] == "Personality: " && ourAnimals[i, 0] != "ID #: ") {
                    Console.WriteLine($"The animal {ourAnimals[i, 0]} has no personality description\n");
